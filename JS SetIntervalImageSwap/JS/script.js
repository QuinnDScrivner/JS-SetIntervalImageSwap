...
var multiButtons = ["ps4c.png", "circle.png", "cross.png", "square.png", "triangle.png", "xBox.png", "b.jpg", "a.jpg", "y.jpg", "x.jpg"]
window.addEventListener("load", function () {
  this.document.querySelector("img").src = path + psB[0];
  var timerCount3 = this.setInterval(randImg, 1000);
});

function randNum() {
  let randNumGen = Math.floor(Math.random() * multiButtons.length);
  console.log(randNumGen);
  return randNumGen;
}

function randImg() {
  document.getElementById("ps4c").src = path + multiButtons[randNum()];
}
